...
+ gotenberg:
+   image: gotenberg/gotenberg:latest-libreoffice
+   environment:
...
If your Gotenberg service is not reachable at the default
`http://gotenberg:3000`, also set the connection env variables:
